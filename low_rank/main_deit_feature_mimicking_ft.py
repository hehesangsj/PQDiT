...
def main(config):
    ...
    # qkv_len =  [128, 128, 192, 224, 320, 320, 352, 352, 448, 768, 768, 768]
    # fc1_len = [160, 160, 224, 320, 320, 352, 352, 384, 768, 768, 768, 768]
    # fc2_len = [288, 224, 256, 288, 288, 288, 384, 480, 768, 768, 768, 480]
    # qkv_use_uv = [True, True, True, True, True, True, True, True,   True,  False, False, False]
    # fc1_use_uv = [True, True, True, True, True, True, True, True,   False,  False, False, False]
    ...
    qkv_use_uv = [True, True, True, True, True, True, True, True, True, False, False, True]
    fc1_use_uv = [True, True, False, True, True, True, True, True, False, True, True, False]
    fc2_use_uv = [False, True, True, True, True, True, True, True, True, True, True, True]
