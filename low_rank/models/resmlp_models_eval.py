...
class layers_scale_mlp_blocks(nn.Module):
    ...
    def forward(self, x):
        ...
        x = x + self.drop_path(self.gamma_2 * fc2_output)
...
class resmlp_models(nn.Module):
    ...
    def forward_features(self, x):
        ...
        return x[:, 0], fc2_output_list, ffn_input_list, fc1_output_list, act_output_list

    def forward(self, x):
        feature, fc2_output_list, ffn_input_list, fc1_output_list, act_output_list  = self.forward_features(x)
        x = self.head(feature)
        return x ,feature, fc2_output_list, ffn_input_list, fc1_output_list, act_output_list
