...
from pqf.utils.horovod_utils import get_distributed_sampler
...
def _load_imagenet(
    ...
    real_dirname = os.path.realpath(os.path.join(rootpath, suffix))
    dataset = ImageFolder(real_dirname, transform)
