...
from pqf.utils.logging import log_to_summary_writer
from pqf.training.AbstractDataHandler import AbstractDataHandler
from pqf.training.AbstractDataLogger import AbstractDataLogger
from pqf.training.lr_scheduler import LR_Scheduler
from pqf.training.training_types import FinalSummary, IntermediateSummary, TQDMState
...
def train_one_epoch_dit(
    ...
    model_t.eval()
    trainer.reset()
    trainer.handle_data(epoch, logger, verbose)
