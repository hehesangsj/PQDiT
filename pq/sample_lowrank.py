...
def main(args):
    ...
    model_uv.load_state_dict(torch.load("results/low_rank/005-DiT-XL-2/ckpt.pt")['model'])
    model_uv.eval()
    diffusion.forward_val(vae, model.forward_with_cfg, model_uv.forward_with_cfg, cfg=True, name="results/low_rank/005-DiT-XL-2/sample_cfg")
