...
def main(args):
    ...
    print(f"Uncompressed model size: {uncompressed_model_size_bits} bits")
    print(f"Compressed model size: {compressed_model_size_bits} bits")
    print(f"Compression ratio: {uncompressed_model_size_bits / compressed_model_size_bits:.2f}")
